import { i as defineStore, h as fetchDefaults, a as useNuxtApp, f as asyncDataDefaults, g as createError } from './server.mjs';
import { computed, toValue, reactive, ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'vue';
import { v as hash, x as klona, y as parse, z as getRequestHeader, A as destr, B as isEqual, C as setCookie, D as getCookie, E as deleteCookie } from '../runtime.mjs';
...
const useAuthStore = defineStore("auth", {
  ...
  actions: {
    async authenticateUser({ email, password }) {
      var _a;
      const { data, pending } = await useFetch("https://poweramigo.com/smr/api/login", {
        method: "post",
      ...
      if (data.value) {
        ...
        token.value = (_a = data == null ? void 0 : data.value) == null ? void 0 : _a.api_token;
    ...
    async valuesUser() {
      ...
      for (let x in T) {
        const { pending, data } = await useFetch(
          "https://poweramigo.com/smr/api/get/" + T[x] + "/data?date_start=2023-12-01&time_start=12:00:00&date_end=2023-12-08&units=P&interval=1hour&time_end=12:00:00",
          {
            method: "GET",
...
export { useFetch as a, useCookie as b, useAuthStore as u };
//# sourceMappingURL=auth-DblS5Fe7.mjs.map
